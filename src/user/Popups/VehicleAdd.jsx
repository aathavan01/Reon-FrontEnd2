  ...
  return (
    <>
      <button
        ...
        data-bs-target="#VehicleAdd"
      >
        <i class="bi bi-car-front-fill"></i> VehicleAdd
      </button>
              ...
              <form class="row g-3 needs-validation" novalidate>
                <div class="col-md-4">
                  <label for="category" class="form-label">
                    category<i class="bi bi-check2-circle"></i>
                  </label>
                  <select
                ...
                <div class="col-md-4">
                  <label for="location" class="form-label">
                    Vehicle Location<i class="bi-geo-alt-fill"></i>
                  </label>
                  <select
                    aria-label="Default select example"
                    class="form-control"
                  ...
                  <div class="valid-feedback">Looks good!</div>
                  <div class="invalid-feedback">
                    Please select your vehicle location
                  </div>
                </div>
                ...
                <div class="col-md-12 my-4">
                  <div class="form-check">
                    <input
                      ...
                      value="option1"
                    />
                    <label class="form-check-label" for="acType1">
                      AC
                    </label>
                  </div>
                  <div class="form-check">
                    <input
                      ...
                      checked
                    />
                    <label class="form-check-label" for="acType2">
                      Non AC
                    </label>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <label for="yearOfManuffacture" class="form-label">
                    Year Of Manufacture
                  </label>
                  <input
                    type="month"
                ...
                <div class="col-md-6">
                  <label for="vehicleBook" class="form-label">
                    Vehicle Book
                  </label>
                ...
                <div class="col-md-6">
                  <label for="numberPlate" class="form-label">
                    Number Plate
                  </label>
                ...
                <div class="col-md-6">
                  <label for="insurenceAndTax" class="form-label">
                    Insurence and Tax
                  </label>
                  <input
                    type="file"
                ...
                <div class="col-md-6">
                  <label for="3rdPartyInsrence" class="form-label">
                    3rd Party Insurence
                  </label>
                  <input
                    type="file"
